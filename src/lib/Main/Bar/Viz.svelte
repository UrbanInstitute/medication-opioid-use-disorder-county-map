      ...
      {:else}
        <h4>
          {#if $stateMetricData}
            ...
            <span class="bar-percent">{OUD}% of residents
            with opioid use disorder</span>, assuming prescribers offer treatment for {$selectedYear}
            months.
          {/if}
        </h4>
      {/if}
      ...
      <h4>
        {#if $stateMetricData && $countyMetricData}
          ...
          {:else}
            ...
            <span class="bar-percent">{OUD}% of residents
            with opioid use disorder</span>, assuming all prescribers offer treatment for
