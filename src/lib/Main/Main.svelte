...
program per 100,000 residents (state average: ${numberWithCommas(
          ...
          <div class="textWrapper">
            <p>
              ...
              {isStateView
                ? "health care professionals can prescribe any medications in the state"
                : `health care professionals can prescribe any medications in the county (state total: ${numberWithCommas(
                    prescriberState,
                  )}) `}
            </p>
            <p>
              ...
              {isStateView
                ? "percent of prescribers were waivered to prescribe buprenorphine in November 2022"
                : `percent of prescribers were waivered to prescribe buprenorphine in November 2022 (statewide percentage: ${waiverState})`}
            </p>
            <p>
              <span class="number">
          ...
          <div class="textWrapper">
            ...
            <p>
              {#if transitM === "" && transitB === ""}
                {@html "Average travel times via public transit to the nearest buprenorphine treatment and opioid treatment program are not available. See our <a href='https://www.urban.org/research/publication/what-would-it-take-get-medication-opioid-use-disorder-more-people-need-methodological-appendix'>technical appendix</a> for more information."}
              {:else if transitM === ""}
                {@html "We exclude the average public-transit travel time for methadone because a person cannot reasonably access an opioid treatment program via public transit from this county. See our <a href='https://www.urban.org/research/publication/what-would-it-take-get-medication-opioid-use-disorder-more-people-need-methodological-appendix'>technical appendix</a> for more information."}
              {/if}
            </p>
          </div>
        {/if}
...
<section class="aboutSection" class:print={$print}>
  ...
  <p>
  This data tool was funded by Bloomberg Philanthropies as part of the <a href="https://www.bloomberg.org/public-health/combating-the-overdose-epidemic/" target="_blank">Bloomberg Overdose Prevention Initiative</a>, a collaborative partnership aimed at combating the nation’s opioid epidemic.
  </p>
  <p>
    ...
    often the clinical recommendation, and 6 months, because <a
      href="https://jamanetwork.com/journals/jama/fullarticle/2804078"
      target="_blank">research</a
    > indicates people usually receive treatment for fewer than 12 months. Though
    6-month treatment gets treatment to more people, it may also mean treatment is
    less effective.
  </p>
  <p>
  ...
  <div class={$print ? "none" : "buttonsWrapper2"}>
    <a
      href="https://www.urban.org/research/publication/what-would-it-take-get-medication-opioid-use-disorder-more-people-need-methodological-appendix"
    >
...
<section class="creditSection" class:print={$print}>
  ...
  <div class="creditItem">
    <p>
      View the project on <a
        href="https://github.com/UrbanInstitute/medication-opioid-use-disorder-county-map"
