...
<p class="map-note"><strong>Note:</strong> Our estimates of the number of people receiving medication treatment for opioid use disorder in counties with small populations may be less reliable than in other counties.</p>
