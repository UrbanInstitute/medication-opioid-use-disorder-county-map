...
<div class="toggle-selection">
  ...
  <div id="yearToggle">
    ...
    <p class="help-text">Reducing the default treatment length changes the size of the current opioid treatment gap. We use 6 and 12 months as treatment lengths because they are commonly used for benchmarking, but treatment guidelines recommend patients remain in treatment as long as it’s effective, which may be longer than 12 months.</p>
    <!-- <Icon -->
